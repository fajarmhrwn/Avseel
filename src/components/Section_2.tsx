...
const Section_2 = ({id}:{id:string}) => {
  ...
  return (
    <div id={id} ref={ref} className="relative flex flex-col bg-[url('/images/Background4.png')] bg-cover bg-center h-128 sm:min-h-screen flex justify-center items-center p-12 pb-36 sm:pb-2">
